  ...
  return (
    <div className="group bg-white rounded-2xl p-5 border border-slate-200 hover:border-brand-400 hover:shadow-md transition flex flex-col gap-3">
      ...
      <div className="mt-auto flex flex-col gap-2 pt-2">
        ...
        <Link
          href={`/quiz/answers?chapter=${chapter.key}`}
          className="inline-flex items-center justify-center gap-1 text-center text-xs font-semibold text-slate-500 hover:text-brand-600 hover:bg-slate-50 py-1.5 rounded-lg transition"
        >
          <svg
            aria-hidden="true"
